...
% -----------------------------------%
function [Tr_p1, Tr_p2, Tr_p3] = pTr_partition(pEc, wa1, wa2, wa3, soilpar, pftpar, wetness, zm)
% ------- function input -------
...
% -------
    ...
    Tr_p1 = (1 - wetness) * beta1 * pEc;
    Tr_p2 = (1 - wetness) * beta2 * pEc;
    Tr_p3 = (1 - wetness) * beta3 * pEc;
