...
% Case 1 -- groundwater table in layer 1  %
% --------------------------------------- %
function [wa, zgw, Tr, Es, uex] = swb_case1(wa, IWS, pEc, pEs, s_tem, s_vpd, ...
    soilpar, pftpar, wet, zm, zgw)
% function input:
% ----------
% wa      -- soil water content, 3 layers
...
% Case 2 -- groundwater table in layer 2  %
% --------------------------------------- %
function [wa, zgw, Tr, Es, uex] = swb_case2(wa, IWS, pEc, pEs, s_tem, s_vpd, ...
    soilpar, pftpar, wet, zm, zgw)
% function input:
% ----------
% wa      -- soil water content, 3 layers
...
% Case 3 -- groundwater table in layer 3  %
% --------------------------------------- %
function [wa, zgw, Tr, Es, uex] = swb_case3(wa, IWS, pEc, pEs, s_tem, s_vpd, ...
    soilpar, pftpar, wet, zm, zgw)
% function input:
% ----------
% wa      -- soil water content, 3 layers
...
% --------------------------------------- %
function [wa, zgw, Tr, Es, uex] = swb_case4(wa, IWS, pEc, pEs, s_tem, s_vpd, ...
    soilpar, pftpar, wet, zm, zgw)
% function input:
% ----------
% wa      -- soil water content, 3 layers
